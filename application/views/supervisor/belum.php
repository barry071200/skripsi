        ...
        <tbody>
            ...
            foreach ($timesheet as $dt) : ?>
                <tr>
                    ...
                    <td>
                        <form method="post" action="<?php echo site_url("supervisor/belum") ?>">
                            <a class="btn btn-success" href="<?php echo site_url("supervisor/belum") . "/" . $dt['id_timesheet'] . "/" . $valid; ?>">Diterima</a>
                            <a class="btn btn-warning" href="<?php echo site_url("supervisor/belum") . "/" . $dt['id_timesheet'] . "/" . $tValid; ?>">Ditolak</a>
                        </form>
                    </td>
